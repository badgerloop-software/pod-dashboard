...
class Dropdown {
    ...
    fillList() {
        ...
        subsystems.forEach((subsystem) => {
            ...
            // Create an array with all sensors in the subsystem
            let sensors = Object.keys(currentSystem);
            sensors.forEach((sensor) => {
                // For each sensor create an element
                this.createItem(`${sensor}`, `${currentSystem[sensor].units}`, subsystem);
            });
        });
    }
    ...
    createItem(name, units, system) { // eslint-disable-line no-unused-vars
        ...
        // Splits the camel case into two words and adds the units
